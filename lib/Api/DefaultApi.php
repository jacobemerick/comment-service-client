...
class DefaultApi
{
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->createCommenterWithHttpInfo ($body);
        return $response; 
    }


    /**
     * createCommenterWithHttpInfo
     *
     * 
     *
     * @param \Jacobemerick\CommentService\Model\Body $body  (optional)
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->replaceCommentWithHttpInfo ($comment_id);
        return $response; 
    }


    /**
     * replaceCommentWithHttpInfo
     *
     * 
     *
     * @param string $comment_id Comment identifier. (required)
    ...
    public function replaceCommentWithHttpInfo($comment_id)
    {
        ...
        // verify the required parameter 'comment_id' is set
        if ($comment_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $comment_id when calling replaceComment');
        }
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->deleteCommentWithHttpInfo ($comment_id);
        return $response; 
    }
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->updateCommentWithHttpInfo ($comment_id);
        return $response; 
    }
